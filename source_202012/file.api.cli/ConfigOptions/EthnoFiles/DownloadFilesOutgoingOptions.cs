...
{
    [Verb("downloadfilesoutgoing", HelpText = "Downloads outgoing files for user (both historical and non historical).")]
    public class DownloadFilesOutgoingOptions : IOptions
    {

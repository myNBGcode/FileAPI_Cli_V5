...
{
    class RetrieveFilesIncomingHistoricValidator : ICommandValidator<RetrieveFilesIncomingHistoricCmd>
    {
        public bool IsCommandValid(RetrieveFilesIncomingHistoricCmd command)
        {

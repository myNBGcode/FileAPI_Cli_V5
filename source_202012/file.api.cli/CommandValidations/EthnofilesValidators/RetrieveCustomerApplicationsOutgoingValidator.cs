...
{
    class RetrieveCustomerApplicationsOutgoingValidator : ICommandValidator<RetrieveCustomerApplicationsOutgoingCmd>
    {
        public bool IsCommandValid(RetrieveCustomerApplicationsOutgoingCmd command)
        {

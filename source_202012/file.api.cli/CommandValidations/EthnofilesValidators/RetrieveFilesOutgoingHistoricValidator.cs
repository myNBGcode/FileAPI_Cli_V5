...
{
    class RetrieveFilesOutgoingHistoricValidator : ICommandValidator<RetrieveFilesOutgoingHistoricCmd>
    {
        public bool IsCommandValid(RetrieveFilesOutgoingHistoricCmd command)
        {
